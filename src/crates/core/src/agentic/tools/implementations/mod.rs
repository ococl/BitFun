...
pub mod control_external_app_tool;
pub mod external_app_command_tool;
pub mod external_app_manager_tool;
pub mod control_hub;
...
pub use external_app_command_tool::ExternalAppCommandTool;
pub use external_app_manager_tool::ExternalAppManagerTool;
